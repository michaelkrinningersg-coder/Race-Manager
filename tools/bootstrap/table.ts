/**
 * Dateiinterne Pruefung einer Stammdatentabelle: Kopfzeile, Typen,
 * Wertebereiche, Eindeutigkeit, Primaerschluessel, Sortierung.
 *
 * BEWUSST OHNE JEDEN NODE-IMPORT. Diese Datei wird von zwei Seiten benutzt:
 * vom Bootstrapper, der die Dateien vom Datentraeger liest, und vom Editor im
 * Browser, der denselben Text aus einem Netzabruf bekommt. Waere die Pruefung
 * weiterhin mit dem Dateizugriff verheiratet, muesste der Editor die Regeln
 * nachbauen - und zwei Fassungen derselben Regel laufen immer auseinander.
 *
...
/**
 * Prueft CSV-Text gegen eine Tabellenspezifikation.
 *
 * Reine Funktion: Text rein, geprueftes Ergebnis und Befunde raus. Woher der
 * Text stammt, ist ihr gleichgueltig.
 */
export function buildTable(text: string, spec: TableSpec, findings: Finding[]): LoadedTable {
